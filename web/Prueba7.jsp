...
<html>
    ...
    <body>      
        ...
        <label>Marca</label>
        <select id="listarMarca" onchange="seleccionarMarca()">
            <option>  Cargando marca...</option>
        </select><br>
       
        <label>Marca Seleccionada:</label>
        <input type="text" name="info1" id="text1" value="--Elija Marca--"><br>
    
        <label>Año</label>
        <select id="listarAño" onchange="seleccionarAño()">
        ...
        <input type="text" name="info3" id="text2" value="--Elija Año--"><br>         

        <label>Modelo</label>
        <select id="listarModelo" onchange="modeloSeleccionada()">
        </select><br> 
        <label>Modelo Seleccionado:</label>        
        <input type="text" name="info2" id="text3" value="--Elija Modelo--"><br>  
