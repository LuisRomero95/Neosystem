...
$(document).ready(function (){
       ...
       $('input[name=txtTipoEnvio]:checked').val(convertido);
        ...
        $('#listarCliente').change(function (){
            var nivel = $('#listarCliente option:selected').text().trim();
            $('#cliente_id').val(nivel);
        });        
    ...
    $('#unit').change(function (){        
     ...
     $('#limpiar').click(function () {
          ...
          var indice = $('#listarCliente').val().trim();
            if ( indice === '' ){
                alert('[ERROR] Confirme al Cliente');
                return false;
            } 
     });
        $('#doAction').click(function (e) {
            ...
            if(envio === 'sobre' ){
                ...
                if(peso <= pesolimiteSobre){
                    ...
                    alert('[ERROR] Si es mayor a 501 gramos entonces no cuenta como sobre');
                    return false;
                }
            }       
            if(envio === 'paquete' ){
