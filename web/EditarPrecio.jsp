        ...
        <div class="container">
            ...
            <div class="col-md-6 col-md-offset-3 opciones">
                ...
                <div class="form-group"> <!-- Identificación-->
                    ...
                    <div>
                        <label for="listarCliente" class="control-label">Cliente</label>
                        <br>
                        <select name="txtCliente" id="listarCliente" class="form-control">
                        ...
                        <div class="form-group">
                            <label for="cliente_id" class="control-label">Cliente SELECCIONADO</label>
                            <input type="text"  class="form-control" id="cliente_id" readonly="" value=<c:out value="${precio.cliente}" />  >
                        </div>                           
                    </div>   
            </div>
            <div id="radios">
                ...
                <div class="col-md-6 col-md-offset-3 opciones">
                    ...
                    <input type="text" name="txtContenedorEnvio" id="contenedorEnvio" value=<c:out value="${precio.tipo}" />  >
                </div>
            ...
            <div class="col-md-6 col-md-offset-3">
                <div class="form-group">
                    ...
                    <input type="text" name="txtResultado" id="resultado"  value=<c:out value="${precio.resultado}" />  >       
                </div>  
                <br>
                <div class="form-group">
                    <div align="center">
                        <input type="submit" name="btnEditar" value="Actualizar" id="editar" class="btn btn-success btn-lg" onclick="return confirm('¿Desea registrar este precio?')">
